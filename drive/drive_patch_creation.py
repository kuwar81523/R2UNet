...
def make_folders_drive():   
    dataset_folder = r"C:\Users\vamsi\Documents\AI\data\dataset\DRIVE\\"
    
    training_images_folder = os.path.join(dataset_folder,"training\\images")
    training_gt_folder = os.path.join(dataset_folder,"training\\1st_manual")
    
    patch_image_folder = r"C:\Users\vamsi\Documents\AI\data\dataset\DRIVE\training\image_patches\\"
    patch_mask_folder = r"C:\Users\vamsi\Documents\AI\data\dataset\DRIVE\\training\mask_patches\\"
    ...
    for i,img in enumerate(img_list):
        ...
        image = tiff.imread(training_images_folder+"\\"+img)
        image = Image.fromarray(image)
        mask = Image.open(training_gt_folder+"\\"+img.split("_")[0]+"_manual1.gif")
        w,h = image.size
